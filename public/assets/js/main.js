...
class Game {
  constructor() {
    ...
    this.scene.fog = new THREE.Fog(COL.bg, 60, 480);
  ...
  renderTextState() {
    ...
    if (this.modeName === "cycle" && this.mode.cycles) {
      ...
      base.controls = {
        boost: !!this.mode.cycles[0].boosting,
        emergencyStops: this.mode.stopsLeft,
        dashboardHeight: Number((this.mode.dashboardHeight || 0).toFixed(2)),
        steerInput: Number((this.mode.steerVisual || 0).toFixed(2)),
      };
